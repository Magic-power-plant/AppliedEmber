...
/**
 * Wires the Embers energy type into AE2: key-type registration, capability registration/attachment, and the
 * three stack-world strategies (external storage, export bus, import bus).
 *
